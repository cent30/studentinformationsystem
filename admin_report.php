            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h4>Admin Details
                            <center><a href="admin.php" class="btn btn-primary float-end">Add Admin</a></center>
<form method="post" action="export3.php">
     <input type="submit" name="export3" class="btn btn-success" value="Export Data" />
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $student)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="admin-view.php?id=<?= $student['id']; ?>" class="btn btn-info btn-sm">View</a>
                                                    <a href="admin-edit.php?id=<?= $student['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                    <form action="code3.php" method="POST" class="d-inline">
                                                        <button type="submit" name="delete_admin" value="<?=$student['id'];?>" class="btn btn-danger btn-sm">Delete</button>
                                                    </form>
                                                </td>
                                            </tr>
                                            <?php
