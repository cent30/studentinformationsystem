            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h4>Town Details
                            <center><a href="address.php" class="btn btn-primary float-end">Add Town</a></center>
<form method="post" action="export7.php">
     <input type="submit" name="export7" class="btn btn-success" value="Export Data" />
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $student)
                                        {
                                            ...
                                            <tr>
                                               ...
                                               >
                                                <td>
                                                    <a href="town-view.php?id=<?= $student['id']; ?>" class="btn btn-info btn-sm">View</a>
                                                    <a href="town-edit.php?id=<?= $student['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                    <form action="code7.php" method="POST" class="d-inline">
                                                        <button type="submit" name="delete_town" value="<?=$student['id'];?>" class="btn btn-danger btn-sm">Delete</button>
                                                    </form>
                                                </td>
                                            </tr>
                                            <?php
