                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="code6.php" method="POST">
                            ...
                            <div class="mb-3">
                                <button type="submit" name="save_barangay" class="btn btn-primary">Save Barangay</button>
                            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="code7.php" method="POST">
                            ...
                            <div class="mb-3">
                                <button type="submit" name="save_town" class="btn btn-primary">Save Town</button>
                            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="code8.php" method="POST">
                            ...
                            <div class="mb-3">
                                <button type="submit" name="save_province" class="btn btn-primary">Save Province</button>
                            </div>
