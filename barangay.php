            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h4>Barangay Details
                            <center><a href="address.php" class="btn btn-primary float-end">Add Barangay</a></center>
<form method="post" action="export6.php">
     <input type="submit" name="export6" class="btn btn-success" value="Export Data" />
      <button onclick="window.print()"class="btn btn-success pull-right"><span class="glyphicon glyphicon-print"></span> Print PDF</button>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php 
                                    $query = "SELECT * FROM barangay_table";
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $student)
                                        {
                                            ...
                                            <tr>
                                                <td><?= $student['id']; ?></td>
                                                <td><?= $student['barangay_name']; ?></td>
                                                <td><?= $student['town_name']; ?></td>
                                                <td><?= $student['date_created']; ?></td>
                                               >
                                                <td>
                                                    <a href="barangay-view.php?id=<?= $student['id']; ?>" class="btn btn-info btn-sm">View</a>
                                                    <a href="barangay-edit.php?id=<?= $student['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                    <form action="code6.php" method="POST" class="d-inline">
                                                        <button type="submit" name="delete_barangay" value="<?=$student['id'];?>" class="btn btn-danger btn-sm">Delete</button>
                                                    </form>
                                                </td>
                                            </tr>
                                            <?php
