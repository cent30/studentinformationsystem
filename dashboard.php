  ...
  <body style="background-image: url(back1.jpg);">
    ...
    <div class="mobile_nav">
      ...
      <div class="mobile_nav_items">
        ...
        <a href="civil_status.php"><i class="fas fa-th"></i><span>Civil Status Report</span></a>
        <a href="view_civil_status.php"><i class="fas fa-th"></i><span>Manage Civil Status</span></a>
