            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h4>Province Details
                            <center><a href="address.php" class="btn btn-primary float-end">Add Province</a></center>
<form method="post" action="export8.php">
     <input type="submit" name="export8" class="btn btn-success" value="Export Data" />
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $student)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="province-view.php?id=<?= $student['id']; ?>" class="btn btn-info btn-sm">View</a>
                                                    <a href="province-edit.php?id=<?= $student['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                    <form action="code8.php" method="POST" class="d-inline">
