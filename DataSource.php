...
if(isset($_POST['insert_data']))
{
    ...
    $query = "INSERT INTO student_table (firstname,middlename,lastname,extensionname,birthday,age,gender,civilstatus,streetnumber,address,barangay,town,province,zipcode,parent,login_id) VALUES ('$firstname','$middlename','$lastname','$extensionname','$birthday','$age','$gender','$civilstatus','$streetnumber','$address','$barangay','$town','$province','$zipcode','$parent','$login_id') ";
