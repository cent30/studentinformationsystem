            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h4>Gender Details
                            <center><a href="gender.php" class="btn btn-primary float-end">Add Gender</a></center>
<form method="post" action="export4.php">
     <input type="submit" name="export4" class="btn btn-success" value="Export Data" />
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $student)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="gender-view.php?id=<?= $student['id']; ?>" class="btn btn-info btn-sm">View</a>
                                                    <a href="gender-edit.php?id=<?= $student['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                    <form action="code4.php" method="POST" class="d-inline">
                                                        <button type="submit" name="delete_gender" value="<?=$student['id'];?>" class="btn btn-danger btn-sm">Delete</button>
                                                    </form>
                                                </td>
                                            </tr>
                                            <?php
